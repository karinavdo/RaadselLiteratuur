d3.csv( 'https://raw.githubusercontent.com/jorisvanzundert/riddle_d3/main/csv/resp_read_suspense.csv' ).then( function( data ) {

  const xAxisTitle = 'Number of books read of genre suspense';
