d3.csv( 'https://raw.githubusercontent.com/jorisvanzundert/riddle_d3/main/csv/chart_10-1_sentence-length.csv' ).then( function( data ) {
  ...
  const svg = d3.select( 'div#chart_10-1_sentence-length' )
    .append( 'svg' )
  ...
  var keys = [ 'Fiction', 'Suspense', 'Romantic', 'Other' ]
  var keys_nl = { 'Fiction': 'Literaire roman',
                 'Suspense': 'Spanning',
                 'Romantic': 'Romantiek',
                 'Other': 'Overige' }
  var size = 30
...
d3.csv( 'https://raw.githubusercontent.com/jorisvanzundert/riddle_d3/main/csv/chart_10-1_sentence-length.csv' ).then( function( data ) {
  ...
  // Append the svg object to the appropriate div.
  const svg = d3.select( 'div#chart_10-2_sentence-length-variance' )
    .append( 'svg' )
      .attr( 'width', plot_width + plot_margin.left + plot_margin.right )
      .attr( 'height', plot_height + plot_margin.top + plot_margin.bottom )
      .append( 'g' )
